        ...
        <div className="relative w-full h-[500px] text-white">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 h-full">
            ...
            <p className="max-w-xl text-base md:text-lg drop-shadow">
              ...
              with your loved ones. Perfect for all ages — tools and plants will
              be provided!
            </p>
      ...
      <SwiperSlide>
        <div className="relative w-full h-[500px] text-white">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 h-full">
            ...
            <p className="max-w-xl text-base md:text-lg drop-shadow">
              Let your kids dig, plant, and grow! A hands-on event that teaches
              children the joy of gardening while having fun outdoors with
              friends.
            </p>
        ...
        <div className="relative w-full h-[500px] text-white">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center text-center px-4 h-full">
            ...
            <p className="max-w-xl text-base md:text-lg drop-shadow">
              ...
              grandparents, parents, and children. Learn, laugh, and plant side
              by side while connecting across generations.
            </p>
            <button className="btn btn-accent mt-6">Join the Experience</button>
          </div>
        </div>
      </SwiperSlide>
    </Swiper>
